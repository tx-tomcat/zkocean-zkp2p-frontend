...
export function isAccount(type: string): boolean { type = compressSuiType(type); return type.startsWith("0xdee9::custodian_v2::Account<"); }
...
export class AccountCap implements StructClass { static readonly $typeName = "0xdee9::custodian_v2::AccountCap"; static readonly $numTypeParams = 0;
 ...
 static fromFields( fields: Record<string, any> ): AccountCap { return AccountCap.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), owner: decodeFromFields("address", fields.owner) } ) }
 ...
 return AccountCap.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), owner: decodeFromFieldsWithTypes("address", item.fields.owner) } ) }
 ...
 static fromJSONField( field: any ): AccountCap { return AccountCap.reified( ).new( { id: decodeFromJSONField(UID.reified(), field.id), owner: decodeFromJSONField("address", field.owner) } ) }
...
export class Custodian<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0xdee9::custodian_v2::Custodian"; static readonly $numTypeParams = 1;
 ...
 return Custodian.reified( typeArg, ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), accountBalances: decodeFromFieldsWithTypes(Table.reified(reified.phantom("address"), reified.phantom(Account.reified(typeArg))), item.fields.account_balances) } ) }
