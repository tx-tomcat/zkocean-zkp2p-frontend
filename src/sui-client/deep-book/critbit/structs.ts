...
export function isCritbitTree(type: string): boolean { type = compressSuiType(type); return type.startsWith("0xdee9::critbit::CritbitTree<"); }

export interface CritbitTreeFields<V extends TypeArgument> { root: ToField<"u64">; internalNodes: ToField<Table<"u64", ToPhantom<InternalNode>>>; leaves: ToField<Table<"u64", ToPhantom<Leaf<V>>>>; minLeaf: ToField<"u64">; maxLeaf: ToField<"u64">; nextInternalNodeIndex: ToField<"u64">; nextLeafIndex: ToField<"u64"> }

export type CritbitTreeReified<V extends TypeArgument> = Reified< CritbitTree<V>, CritbitTreeFields<V> >;

export class CritbitTree<V extends TypeArgument> implements StructClass { static readonly $typeName = "0xdee9::critbit::CritbitTree"; static readonly $numTypeParams = 1;

 readonly $typeName = CritbitTree.$typeName;

 readonly $fullTypeName: `0xdee9::critbit::CritbitTree<${ToTypeStr<V>}>`;

 readonly $typeArgs: [ToTypeStr<V>];

 readonly root: ToField<"u64">; readonly internalNodes: ToField<Table<"u64", ToPhantom<InternalNode>>>; readonly leaves: ToField<Table<"u64", ToPhantom<Leaf<V>>>>; readonly minLeaf: ToField<"u64">; readonly maxLeaf: ToField<"u64">; readonly nextInternalNodeIndex: ToField<"u64">; readonly nextLeafIndex: ToField<"u64">

 private constructor(typeArgs: [ToTypeStr<V>], fields: CritbitTreeFields<V>, ) { this.$fullTypeName = composeSuiType( CritbitTree.$typeName, ...typeArgs ) as `0xdee9::critbit::CritbitTree<${ToTypeStr<V>}>`; this.$typeArgs = typeArgs;
 ...
 root: bcs.u64(), internal_nodes: Table.bcs, leaves: Table.bcs, min_leaf: bcs.u64(), max_leaf: bcs.u64(), next_internal_node_index: bcs.u64(), next_leaf_index: bcs.u64()
 ...
 return CritbitTree.reified( typeArg, ).new( { root: decodeFromFieldsWithTypes("u64", item.fields.root), internalNodes: decodeFromFieldsWithTypes(Table.reified(reified.phantom("u64"), reified.phantom(InternalNode.reified())), item.fields.internal_nodes), leaves: decodeFromFieldsWithTypes(Table.reified(reified.phantom("u64"), reified.phantom(Leaf.reified(typeArg))), item.fields.leaves), minLeaf: decodeFromFieldsWithTypes("u64", item.fields.min_leaf), maxLeaf: decodeFromFieldsWithTypes("u64", item.fields.max_leaf), nextInternalNodeIndex: decodeFromFieldsWithTypes("u64", item.fields.next_internal_node_index), nextLeafIndex: decodeFromFieldsWithTypes("u64", item.fields.next_leaf_index) } ) }
 ...
 static fromJSONField<V extends Reified<TypeArgument, any>>( typeArg: V, field: any ): CritbitTree<ToTypeArgument<V>> { return CritbitTree.reified( typeArg, ).new( { root: decodeFromJSONField("u64", field.root), internalNodes: decodeFromJSONField(Table.reified(reified.phantom("u64"), reified.phantom(InternalNode.reified())), field.internalNodes), leaves: decodeFromJSONField(Table.reified(reified.phantom("u64"), reified.phantom(Leaf.reified(typeArg))), field.leaves), minLeaf: decodeFromJSONField("u64", field.minLeaf), maxLeaf: decodeFromJSONField("u64", field.maxLeaf), nextInternalNodeIndex: decodeFromJSONField("u64", field.nextInternalNodeIndex), nextLeafIndex: decodeFromJSONField("u64", field.nextLeafIndex) } ) }
...
export function isInternalNode(type: string): boolean { type = compressSuiType(type); return type === "0xdee9::critbit::InternalNode"; }
...
export function isLeaf(type: string): boolean { type = compressSuiType(type); return type.startsWith("0xdee9::critbit::Leaf<"); }
